...
The data Sparkify wanted to analyze was present in JSON format and it was not easy for them to query the database in order to find insights from the data. The database design helped them in optimising queries on song play analysis. 


#### State and justify your database schema design and ETL pipeline.

We created database schema and ETL pipeline for the analysis. The ETL pipeline helped in the transfer of data from files in two local directories into tables in Postgres using Python and SQL 

We created a star schema optimized for queries on song play analysis. The FACTS table was 'songplays' and dimension tables were 'users', 'songs', 'artists', 'time'   
